...
#[test]
fn test_tr31_wrap_example_a_7_4() {
...
#[test]
fn test_tr31_wrap_example_aes_128() {
    for_each_crypto_provider!(provider, {
...
#[test]
fn test_tr31_wrap_example_aes_128_masked_length() {
    for_each_crypto_provider!(provider, {
        let header = KeyBlockHeader::new_with_values("D", "P0", "T", "E", "00", "N").unwrap();
...
#[test]
fn test_tr31_wrap_example_aes_128_two_optional_blocks() {
    for_each_crypto_provider!(provider, {
...
#[test]
fn test_tr31_wrap_example_aes_192_no_optional_blocks() {
    for_each_crypto_provider!(provider, {
        let header = KeyBlockHeader::new_with_values("D", "P0", "T", "E", "00", "N").unwrap();

        let key = hex::decode("AABBCCDDEEFFAABB").unwrap();

        let masked_key_length = 24;
...
#[test]
fn test_tr31_wrap_example_aes_192_no_optional_blocks_masked_length() {
    for_each_crypto_provider!(provider, {
...
#[test]
fn test_tr31_wrap_example_aes_192_two_optional_blocks() {
    for_each_crypto_provider!(provider, {
        let header =
            KeyBlockHeader::new_from_str("D0048P0TE00N0200KS1800604B120F9292800000PB080000")
                .unwrap();
...
#[test]
fn test_tr31_wrap_example_aes_192_one_optional_block_finalized() {
    for_each_crypto_provider!(provider, {
        let mut header =
...
#[test]
fn test_tr31_wrap_example_aes_256_no_optional_blocks_no_masked_length() {
    for_each_crypto_provider!(provider, {
        let header = KeyBlockHeader::new_with_values("D", "P0", "T", "E", "00", "N").unwrap();
        ...
        let kbpk = hex::decode("00112233445566778899AABBCCDDEEFF00112233445566778899AABBCCDDEEFF")
            .unwrap();
...
#[test]
fn test_tr31_wrap_example_aes_256_no_optional_blocks_masked_length() {
    for_each_crypto_provider!(provider, {
        let header = KeyBlockHeader::new_with_values("D", "B1", "T", "E", "00", "N").unwrap();

        let key = hex::decode("AABBCCDDEEFFAABBAABBCCDDEEFFAABBAABBCCDDEEFFAABBAABBCCDDEEFFAABB")
            .unwrap();

        let masked_key_length = 64;

        let random_seed = hex::decode(
            "F93271EC6B8E1BD97A9212B0FBDD99A29F8E3B0C655F59D90C039A9D371CEBB01E38BA78196EEA544BD077849344",
        )
        .unwrap();
...
#[test]
fn test_tr31_wrap_example_aes_256_two_optional_blocks() {
    for_each_crypto_provider!(provider, {
        let header =
            KeyBlockHeader::new_from_str("D0048P0TE00N0200KS1800604B120F9292800000PB080000")
                .unwrap();
...
fn test_tr31_wrap_error_key_block_length_not_multiple_of_block_size() {
    for_each_crypto_provider!(provider, {
        ...
        assert!(matches!(
            ...
            Err(e)
                if e.to_string()
                    == "ERROR TR-31: Total block length is not a multiple of block length: 16"
        ));
    });
}

#[test]
fn test_tr31_unwrap_example_a_7_4() {
    for_each_crypto_provider!(provider, {
        ...
        let unwrap_result = tr31_unwrap(&provider, kbpk.as_slice(), AesKeySize::Bits256, key_block);
...
#[test]
fn test_tr31_unwrap_example_aes_128() {
    for_each_crypto_provider!(provider, {
        ...
        let unwrap_result = tr31_unwrap(&provider, kbpk.as_slice(), AesKeySize::Bits128, key_block);
...
#[test]
fn test_tr31_unwrap_example_aes_128_masked_length() {
    for_each_crypto_provider!(provider, {
...
#[test]
fn test_tr31_unwrap_example_aes_128_two_optional_blocks() {
    for_each_crypto_provider!(provider, {
        ...
        assert_eq!(first_opt_block.id(), "KS");

        assert_eq!(first_opt_block.data(), "00604B120F9292800000");

        let second_opt_block = first_opt_block.next().unwrap();

        assert_eq!(second_opt_block.id(), "PB");
        assert_eq!(second_opt_block.data(), "0000");
    });
}

#[test]
fn test_tr31_unwrap_example_aes_192_no_optional_blocks_masked_length() {
    for_each_crypto_provider!(provider, {
        ...
        let unwrap_result = tr31_unwrap(&provider, kbpk.as_slice(), AesKeySize::Bits192, key_block);
...
#[test]
fn test_tr31_unwrap_example_aes_192_two_optional_blocks() {
    for_each_crypto_provider!(provider, {
...
#[test]
fn test_tr31_unwrap_example_aes_256_no_optional_blocks_no_masked_length() {
    for_each_crypto_provider!(provider, {
...
#[test]
fn test_tr31_unwrap_example_aes_256_no_optional_blocks_masked_length() {
    for_each_crypto_provider!(provider, {
        ...
        let expected_key =
            hex::decode("AABBCCDDEEFFAABBAABBCCDDEEFFAABBAABBCCDDEEFFAABBAABBCCDDEEFFAABB")
                .unwrap();
...
#[test]
fn test_tr31_unwrap_example_aes_256_two_optional_blocks() {
    for_each_crypto_provider!(provider, {
...
#[test]
fn test_tr31_wrap_with_header_string_example_a_7_4() {
    for_each_crypto_provider!(provider, {
        ...
        let key_block = tr31_wrap_with_header_string(
            &provider,
            kbpk.as_slice(),
            AesKeySize::Bits256,
            header_str,
...
#[test]
fn test_tr31_wrap_with_header_string_example_aes_256_two_optional_blocks() {
    for_each_crypto_provider!(provider, {
...
#[test]
fn test_tr31_unwrap_wrong_key_block_length() {
    for_each_crypto_provider!(provider, {
...
#[test]
fn test_tr31_unwrap_wrong_minimum_length() {
    for_each_crypto_provider!(provider, {
...
#[test]
fn test_tr31_unwrap_unsupported_version() {
    for_each_crypto_provider!(provider, {
