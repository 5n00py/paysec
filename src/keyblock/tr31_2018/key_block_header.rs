...
//!
//! # Key Block Header (KBH) (TR-31: 2018, p. 15-19)
//!
//! The header contains attribute information about the key, using uppercase ASCII printable
//! characters for better supportability and human readability. The encoding and acceptable
//! characters for each field are defined individually, as outlined in TR-31 specification.
//!
//! # Key Features
//!
...
//!
//! # Key Header Fields as defined in TR-31 Specification
//!
...
//!
//! // Export the header as a string, note that the key block lenght is not set yet...
//! let header_str = header.export_str().unwrap();
//!
//! // Example of how the header would look as a string
//! let expected_header_str = "D0000P0AE00E0200CT0CSomeDataPB140000000000000000";
